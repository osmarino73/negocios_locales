...
- **Copywriting**: Directo, cálido y enfocado en el público local de Apartadó, destacando el arte en manicura, uñas esculpidas, pedicura y productos especializados sin tecnicismos pomposos (*cero "de autor"*).

---

## 🎬 Sistema de Video Scroll Scrubbing (Canvas HTML5)
- **Desktop (16:9)**: 74 fotogramas WebP en `public/frames/desktop/` generados desde `nail_art_web.mp4` (1920x1080) + `poster.webp`.
- **Mobile (9:16 Vertical Nativo)**: 74 fotogramas WebP en `public/frames/mobile/` generados desde `nail_art_movil.mp4` (1080x1920) + `poster.webp`.
...
1. **Smart Header / Navbar Inteligente**:
   ...
   - Activa fondo oscuro `#0e0d0d` con blur al salir del Hero (`currentScrollY > heroBottom - 120`). Auto-hide suave al descender en secciones inferiores.
...
5. **`#nosotros` (Sobre Nosotros & Especialistas)**:
   - Bloque Editorial: Fotografía de salón de uñas con mesas de manicura y lámparas UV + badge VIP flotante + 4 métricas de autoridad + botón de contacto.
...
6. **`#ubicacion` (Mapa & Contacto)**:
   - Barrio La Martina, Cra 95 #N° 96 - 60, Apartadó + Google Maps interactivo embebido (`z=16`).
7. **Footer Principal**:
