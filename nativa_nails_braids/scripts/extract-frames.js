...
const videoPath = 'c:/Users/Rio Belen/negocios_locales/.agents/document/Model_showing_nails_covering_face_202609101225.mp4';
...
console.log('=== Extrayendo fotogramas Mobile (720x1280 @ 18fps, Q76 con paneo dinámico y vertical offset y=60) ===');
// Paneo dinámico: de x_factor = 0.58 en t=0s a 0.50 en t=4.0s con y=60 para incluir labios y zona segura
const mobilePattern = path.join(mobileDir, 'frame-%04d.webp').replace(/\\/g, '/');
const mobileFilter = "crop=608:1080:'(1920-608)*(0.58-0.08*(t/4.0))':60,scale=720:1280:flags=lanczos";
