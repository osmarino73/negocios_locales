...
// Save back to index.html (and also create index_standalone.html)
fs.writeFileSync(path.join(__dirname, 'index.html'), html, 'utf8');
fs.writeFileSync(path.join(__dirname, 'index_standalone.html'), html, 'utf8');

console.log('Successfully created standalone HTML files!');
