...
console.log('Building standalone HTML for Cris Barbershop...');

const indexPath = path.join(__dirname, 'index.html');
const cssPath = path.join(__dirname, 'styles.css');
const outputPath = path.join(__dirname, 'cris_barbershop_standalone.html');
...
const rootOutputPath = path.join(__dirname, '..', 'cris_barbershop_standalone.html');

fs.writeFileSync(outputPath, html, 'utf8');
fs.writeFileSync(rootOutputPath, html, 'utf8');

console.log('Successfully generated 100% standalone HTML for Cris Barbershop!');
