...
console.log('Building standalone HTML for Veterinaria Los Almendros...');

const indexPath = path.join(__dirname, 'index.html');
const cssPath = path.join(__dirname, 'styles.css');
const outputPath = path.join(__dirname, 'veterinaria_los_almendros_standalone.html');
...
const rootOutputPath = path.join(__dirname, '..', 'veterinaria_los_almendros_standalone.html');

fs.writeFileSync(outputPath, html, 'utf8');
fs.writeFileSync(rootOutputPath, html, 'utf8');

console.log('Successfully generated 100% standalone HTML for Veterinaria Los Almendros!');
